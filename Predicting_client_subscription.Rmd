...
bank_data_mod %>% 
  mutate(new_col = 1, id_col = seq(1, length(bank_data_mod$job), 1)) %>% #id_col because pivot easy to work with then, removed later
  pivot_wider(names_from = education, values_from = new_col, values_fill = 0)
