...
cv_glasso <- cv.gglasso(
  ...
  group = groups,
  loss = "logit",
  lambda = c(seq(0.00001, 0.001, 0.00001), 0.002, 0.003, 0.004, 0.012, 0.1),
  pred.loss = "misclass",
  nfolds = 10
)
plot(cv_glasso)
...
tree_parameters <- rpart.control(minsplit = 60, maxcompete = 10, maxdepth = 5, cp = 0.005)
...
verification::roc.plot(test$y, hej, thresholds = seq(0, 1, 0.1))
